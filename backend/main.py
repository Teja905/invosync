...
_ALLOWED_ORIGINS = [
    o.strip() for o in os.getenv("ALLOWED_ORIGINS", "http://localhost:5173,http://localhost:3000,https://frontend-delta-wine-82.vercel.app,https://invosync-wheat.vercel.app,https://invosync.vercel.app").split(",") if o.strip()
]
app.add_middleware(
    CORSMiddleware,
